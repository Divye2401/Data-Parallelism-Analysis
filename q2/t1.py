...
class ThreadingSolution:
    ...
    def run(self):
        ...
        airline= final_result.groupby("Airline").sum().reset_index() # If an airline has the most flights for the criteria, its bound to have the highest percentage also
        
        
        msg=f'Airline {airline.loc[airline["Count"].idxmax(), "Airline"]} had greatest percentage on time arrivals, Time taken was'
